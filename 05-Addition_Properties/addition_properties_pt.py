...
class AdditionProperties(Scene):
	...
	def construct(self):
		title = Text("Propriedades da Soma").to_edge(UP)
		first_property = Text("1. Associatividade")
		second_property = Text("2. Comutatividade")
		third_property = Text("3. Elemento Neutro")
	...
	def nullElementProperty(scene, title, properties):
		...
		canonical = MathTex("Se\;", "a + b", "=", "a", ",\;logo\;", "b = 0")
		null_element = Tex("O elemento neutro da soma é 0")
